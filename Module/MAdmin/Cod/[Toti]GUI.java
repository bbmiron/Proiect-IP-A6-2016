...
public class GUI extends JPanel {
    ...
    protected JComponent makeTextPanel(String text) {
        ...
        try {
            BufferedImage myPicture = ImageIO.read(new File("C:/Users/BeeBee/Desktop/EmptyPC.png"));
    ...
    public void addTab(String ID, int Tasks, Map<Integer, List<FctState>> noduri){
    	users.add(ID);
